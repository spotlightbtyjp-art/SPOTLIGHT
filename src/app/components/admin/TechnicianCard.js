...
export default function TechnicianCard({ technician, isSelected, onSelect, isAvailable }) {
    return (
        <div
        ...
        >
            ...
            <div className="flex-1">
                <p className="font-bold text-sm text-gray-800">{technician.firstName} {technician.lastName}</p>
            </div>
