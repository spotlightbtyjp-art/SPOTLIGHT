...
function SelectDateTimeContent() {
    ...
    const selectedAreaOptionsParam = searchParams.get('selectedAreaOptions'); // JSON string for area-based-options
                        ...
                        <div className="bg-white rounded-2xl p-4 border border-primary shadow-sm">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1 overflow-hidden">
                                    ...
                                    {/* แสดงรายละเอียด Area-Based-Options */}
                                    {service.serviceType === 'area-based-options' && selectedAreaOptionsParam && (
                                        <div className="mt-1">
                                            <p className="text-sm font-medium text-primary-dark">
                                                เลือก {Object.keys(JSON.parse(selectedAreaOptionsParam)).length} รายการ
                                            </p>
                                        </div>
                                    )}
