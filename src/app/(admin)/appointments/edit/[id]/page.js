...
export default function EditAppointmentPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const techniciansQuery = query(collection(db, 'technicians'), where('status', '==', 'available'), orderBy('firstName'));

                const [appointmentSnap, servicesSnapshot, techniciansSnapshot] = await Promise.all([
                ...
                setBeauticians(techniciansSnapshot.docs.map(doc => ({ id: doc.id, ...doc.data() })));
    ...
    // Check technician availability when date/time changes
    useEffect(() => {
